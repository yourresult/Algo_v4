...
// var kFun = require("./kiteFunctions");
...
var KiteTicker = function(params) {
	// var root = params.root || "wss://ws.zerodha.com/";
	...
	this.connect = function() {
		...
		var url = "wss://ws.zerodha.com/?api_key=kitefront&user_id=NF9455&public_token=5E81B7YULJOl5ytrZlPsj4OHbDaI2zQE&uid=1583226907566&user-agent=kite3-web&version=2.4.0";
	...
	function parseTextMessage(data) {
		...
		if (data.type === "order") {
			// console.log(data);
			trigger("order_update", [data]); // Changed [data.data] to data
		}
	}
